...
export type CameraSource = "webcam" | "dslr-edsdk" | "dslr-dcc" | "dslr-gphoto2";
...
export interface BoothConfig {
  camera: {
    ...
    dccUrl: string;
    gphoto2Bin: string;
    /** Optional path to EDSDK.dll / libEDSDK.so. Empty = bundled copy. */
    edsdkLib: string;
    countdown: number;
  };
  printer: {
...
export const DEFAULT_CONFIG: BoothConfig = {
  camera: { source: "webcam", dccUrl: "http://localhost:5513", gphoto2Bin: "gphoto2", edsdkLib: "", countdown: 7 },
