...
// (via digiCamControl on Windows or gphoto2), printing, frame templates, and
// operator config.
//
// Env:
...
const DEFAULT_CONFIG = {
  camera: {
    source: "webcam", // "webcam" | "dslr-dcc" | "dslr-gphoto2"
...
// digiCamControl live view frame (best effort passthrough)
